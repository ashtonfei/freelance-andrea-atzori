...
class App {
  ...
  getEmailData() {
    ...
    const htmlBody = this.createHtmlBody(contentValues, contentFormulas, contentBorders, width)
    const data = {
      recipient,
      subject,
      options: {
